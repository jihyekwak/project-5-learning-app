    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(blank=True, choices=[('difficult', 'difficult'), ('easy', 'easy'), ('medium', 'medium')], max_length=20)),
                ('grade', models.CharField(blank=True, choices=[('1st Grage', '1st Grade'), ('3rd Grage', '3rd Grade'), ('2nd Grage', '2nd Grade'), ('Pre-k', 'Pre-K'), ('Kindergarten', 'Kindergarten')], max_length=50)),
