...
import { Grid, Dialog, Paper, Typography, TableContainer, Table, TableBody, TableCell, TableHead, TableRow, } from "@material-ui/core";
...
const StudentReport = ({student, setStudent, fetchProfile}) => {
    ...
    <>
        ...
        <Paper className={classes.paper}>
        <TableContainer>
            <Typography variant='h6' className={classes.paperTitle}>Taken Quizzes</Typography>
